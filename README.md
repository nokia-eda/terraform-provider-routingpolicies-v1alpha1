# terraform-provider-routingpolicies-v1alpha1

terraform-provider-routingpolicies-v1alpha1 is a terraform provider plugin for the `routingpolicies` resource in Nokia EDA.
