...
func AsPathSetResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ASPathSet$"), ""),
				},
				Default: stringdefault.StaticString("ASPathSet"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the ASPathSet",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ASPathSetStatus defines the observed state of ASPathSet",
			},
		},
	}
}

type AsPathSetModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	regexModeAttribute, ok := attributes["regex_mode"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`regex_mode is missing from object`)

		return nil, diags
	}

	regexModeVal, ok := regexModeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`regex_mode expected to be basetypes.StringValue, was: %T`, regexModeAttribute))
	}
...
type SpecValue struct {
	...
	RegexMode basetypes.StringValue `tfsdk:"regex_mode"`
	state     attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["regex_mode"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.RegexMode.ToTerraformValue(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"regex_mode": basetypes.StringType{},
		}), diags
	}
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.RegexMode.Equal(other.RegexMode) {
		return false
	}
