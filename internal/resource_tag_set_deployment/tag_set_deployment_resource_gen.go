...
package resource_tag_set_deployment
...
func TagSetDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TagSetDeployment$"), ""),
				},
				Default: stringdefault.StaticString("TagSetDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TagSetDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"node": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies a Node to deploy this Set on",
					},
					"tag_set": schema.StringAttribute{
						Optional:            true,
						Description:         "Specifies a TagSet to deploy to the specified Node",
						MarkdownDescription: "Specifies a TagSet to deploy to the specified Node",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "TagSetDeploymentSpec defines the desired state of TagSetDeployment",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TagSetDeploymentStatus defines the observed state of TagSetDeployment",
			},
		},
	}
}

type TagSetDeploymentModel struct {
