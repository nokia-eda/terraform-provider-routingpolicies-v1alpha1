...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/resource_prefix_set"
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/tfutils"
)

const (
	create_rs_prefixSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/prefixsets"
	read_rs_prefixSet   = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/prefixsets/{name}"
	update_rs_prefixSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/prefixsets/{name}"
	delete_rs_prefixSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/prefixsets/{name}"
)
