...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/resource_as_path_set"
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/tfutils"
)

const (
	create_rs_asPathSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/aspathsets"
	read_rs_asPathSet   = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/aspathsets/{name}"
	update_rs_asPathSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/aspathsets/{name}"
	delete_rs_asPathSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/aspathsets/{name}"
)

var (
	_ resource.Resource                = (*asPathSetResource)(nil)
	_ resource.ResourceWithConfigure   = (*asPathSetResource)(nil)
	_ resource.ResourceWithImportState = (*asPathSetResource)(nil)
)
...
func (r *asPathSetResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *asPathSetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_asPathSet, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_asPathSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_asPathSet,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *asPathSetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_asPathSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *asPathSetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_asPathSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *asPathSetResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
