...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/resource_tag_set"
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/tfutils"
)

const (
	create_rs_tagSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/tagsets"
	read_rs_tagSet   = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/tagsets/{name}"
	update_rs_tagSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/tagsets/{name}"
	delete_rs_tagSet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/tagsets/{name}"
)

var (
	_ resource.Resource                = (*tagSetResource)(nil)
	_ resource.ResourceWithConfigure   = (*tagSetResource)(nil)
	_ resource.ResourceWithImportState = (*tagSetResource)(nil)
)
...
func (r *tagSetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_tagSet, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_tagSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *tagSetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_tagSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *tagSetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_tagSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
