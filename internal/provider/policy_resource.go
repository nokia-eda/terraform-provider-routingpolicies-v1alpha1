...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/resource_policy"
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/tfutils"
)

const (
	create_rs_policy = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/policys"
	read_rs_policy   = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/policys/{name}"
	update_rs_policy = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/policys/{name}"
	delete_rs_policy = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/policys/{name}"
)
...
func (r *policyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_policy, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_policy, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *policyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_policy, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *policyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_policy, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
