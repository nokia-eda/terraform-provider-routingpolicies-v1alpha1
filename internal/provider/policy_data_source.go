...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/datasource_policy"
...
const read_ds_policy = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/policys/{name}"
...
func (d *policyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_policy, map[string]string{
...
func (r *policyDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
