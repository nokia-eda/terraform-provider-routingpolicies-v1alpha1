...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/eda/utils"
...
var _ provider.Provider = (*routingpoliciesProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &routingpoliciesProvider{version: ver}
	}
}

type routingpoliciesProvider struct {
	version string
}
...
func (p *routingpoliciesProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *routingpoliciesProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *routingpoliciesProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "routingpolicies-v1alpha1"
	resp.Version = p.version
}

func (p *routingpoliciesProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewAsPathSetDataSource,
		NewAsPathSetListDataSource,
		NewCommunitySetDataSource,
		NewCommunitySetListDataSource,
		NewPolicyDataSource,
...
func (p *routingpoliciesProvider) Resources(ctx context.Context) []func() resource.Resource {
