...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/resource_community_set"
	"github.com/nokia/eda/apps/terraform-provider-routingpolicies/internal/tfutils"
)

const (
	create_rs_communitySet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/communitysets"
	read_rs_communitySet   = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/communitysets/{name}"
	update_rs_communitySet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/communitysets/{name}"
	delete_rs_communitySet = "/apps/routingpolicies.eda.nokia.com/v1alpha1/namespaces/{namespace}/communitysets/{name}"
)

var (
	_ resource.Resource                = (*communitySetResource)(nil)
	_ resource.ResourceWithConfigure   = (*communitySetResource)(nil)
	_ resource.ResourceWithImportState = (*communitySetResource)(nil)
)
...
func (r *communitySetResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *communitySetResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_community_set.CommunitySetResourceSchema(ctx)
}

func (r *communitySetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_community_set.CommunitySetModel
	...
	err = r.client.Create(ctx, create_rs_communitySet, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_communitySet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_communitySet,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *communitySetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_communitySet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *communitySetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_communitySet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *communitySetResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
