...
func TagSetResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TagSet$"), ""),
				},
				Default: stringdefault.StaticString("TagSet"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TagSet",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TagSetStatus defines the observed state of TagSet",
			},
		},
	}
}
...
func (t TagsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	tagVal, ok := tagAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`tag expected to be basetypes.Int64Value, was: %T`, tagAttribute))
	}
...
func (v TagsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["tag"] = basetypes.Int64Type{}.TerraformType(ctx)
