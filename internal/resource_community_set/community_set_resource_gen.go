...
package resource_community_set
...
func CommunitySetResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^CommunitySet$"), ""),
				},
				Default: stringdefault.StaticString("CommunitySet"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the CommunitySet",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "CommunitySetStatus defines the observed state of CommunitySet",
			},
		},
	}
}

type CommunitySetModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	expressionMatchAttribute, ok := attributes["expression_match"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`expression_match is missing from object`)

		return nil, diags
	}

	expressionMatchVal, ok := expressionMatchAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`expression_match expected to be basetypes.StringValue, was: %T`, expressionMatchAttribute))
	}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["expression_match"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ExpressionMatch.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["expression_match"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			"expression_match":  basetypes.StringType{},
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.ExpressionMatch.Equal(other.ExpressionMatch) {
		return false
	}
