...
package datasource_tag_set_deployment_list
...
func TagSetDeploymentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type TagSetDeploymentListModel struct {
