---
page_title: "routingpolicies-v1alpha1 Provider"
---

# routingpolicies-v1alpha1 Provider

This provider is used to interact with the resources provided by the **routingpolicies-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
